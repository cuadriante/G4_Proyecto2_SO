...
static void ch341_set_termios(struct tty_struct *tty, struct usb_serial_port *port, struct ktermios *old_termios);

//static void ch341_break_ctl_usb(struct tty_struct *tty, int break_state);

//static int ch341_port_remove_usb(struct usb_serial_port *port);
...
static struct usb_serial_driver ch341_device = {
    ...
    .close             = ch341_close,
    // .set_termios     = ch341_set_termios_usb,  // Comment out or remove this line
    ...
    // .port_remove     = ch341_port_remove_usb,  // Comment out or remove this line
